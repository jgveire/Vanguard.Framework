namespace Vanguard.Framework.Core.Parsers
{
    ...
    /// </summary>
    internal class EqualParser
    {
        private readonly TypeConverters _typeConverters = new TypeConverters();
        ...
        /// </exception>
        public BinaryExpression CreateExpression<TEntity>(ParameterExpression parameter)
        {
